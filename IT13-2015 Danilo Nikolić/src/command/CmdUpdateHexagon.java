...
public class CmdUpdateHexagon implements Command {
	...
	public void execute() {
		...
		Hexagon h= new Hexagon(original.getHexagon().getX(),original.getHexagon().getY(),original.getHexagon().getR());
		h.setAreaColor(original.getHexagon().getAreaColor());
		h.setBorderColor(original.getHexagon().getBorderColor());
		h.setSelected(true);
		oldState.setHexagon(h);
		Hexagon h1= new Hexagon(newState.getHexagon().getX(),newState.getHexagon().getY(),newState.getHexagon().getR());
	...
	public void unexecute() {
		Hexagon h2= new Hexagon(oldState.getHexagon().getX(),oldState.getHexagon().getY(),oldState.getHexagon().getR());
