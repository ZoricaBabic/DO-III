...
public class Square extends SurfaceShape implements Moveable{
	...
	public String toString(){
		...
		return "Kvadrat:("+upLeft.getX()+","+upLeft.getY()+"),"+duzinaStranice+" rgb boja-"+ color+":"+colorInside;
	}
	...
	public void selected(Graphics g) {
		...
		new Line(new Point(getGoreLevo().getX(), getGoreLevo().getY()+duzinaStranice), dijagonala().gettKrajnja()).selected(g);
		setSelected(true);
