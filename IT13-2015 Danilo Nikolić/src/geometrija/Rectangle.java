...
public class Rectangle extends Square{
	...
	public String toString(){
		...
		return "Pravougaonik:("+upLeft.getX()+","+upLeft.getY()+"),"+duzinaStranice+"/"+visina+" rgb boja-"+ color+":"+colorInside;
	}
	...
	public void selected(Graphics g) {
		...
		new Line(new Point(getGoreLevo().getX()+duzinaStranice, getGoreLevo().getY()), dijagonala().gettKrajnja()).selected(g);
		new Line(new Point(getGoreLevo().getX(), getGoreLevo().getY()+visina), dijagonala().gettKrajnja()).selected(g);
		setSelected(true);
	}
