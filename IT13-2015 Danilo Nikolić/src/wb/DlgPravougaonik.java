...
public class DlgPravougaonik extends JDialog {
	...
	public DlgPravougaonik() {
		...
		{
			JLabel lblDuzinaStranice = new JLabel("\u0160irina stranice:");
		...
		{
			lblirinaStranice = new JLabel("Visina stranice:");
		...
		}
		{
			...
			pnlBojaUnutrasnjosti.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					pnlBojaUnutrasnjosti.setBackground( JColorChooser.showDialog(null,"Izaberite boju unutrašnjosti kvadrata", Color.BLACK));
				}
			});
