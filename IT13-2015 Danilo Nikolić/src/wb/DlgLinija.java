...
public class DlgLinija extends JDialog {
	...
	public DlgLinija() {
		...
		{
			JLabel lblX = new JLabel("X koordinata po\u010Detne ta\u010Dke :");
		...
		{
			JLabel lblY = new JLabel("Y koordinata po\u010Detne ta\u010Dke :");
		...
		{
			lblXKoordinataKrajnje = new JLabel("X koordinata krajnje ta\u010Dke :");
		...
		{
			lblYKoordinataKrajnje = new JLabel("Y koordinata krajnje ta\u010Dke :");
		...
		{
			JLabel lblBojaIvice = new JLabel("Boja :");
	...
	//				bojaUnutrasnjosti=cbxBojaUnutrasnjosti.getSelectedItem().toString();
							...
							provera=true;
								...
								JOptionPane.showMessageDialog(null, "Nise uneli odgovarajuæe vrednosti");
